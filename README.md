# OrgChart Add-On for Vaadin 10.x

OrgChart Add-On is a Vaadin 10 integration with the WebComponents version of library [OrgChart](https://github.com/dabeng/OrgChart).
